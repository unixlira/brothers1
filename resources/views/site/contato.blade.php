                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12 offset-top-20">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p><span class="wpcf7-form-control-wrap nome"><input type="text" name="nome" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Digite seu Email" /></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-12 offset-top-20">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <p><span class="wpcf7-form-control-wrap nome"><input type="text" name="nome" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Digite seu telefone" /></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <br>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-xl-12 offset-top-20">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <p><span class="wpcf7-form-control-wrap nome"><input type="text" name="nome" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Digite sua cidade" /></span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12 col-sm-7">
