...
<html class="wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page text-center">
          ...
          <nav class="rd-navbar container rd-navbar-floated rd-navbar-dark rd-navbar-dark-transparent" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-menu-wrap">
                ...
                <!--RD Navbar Search-->
                <div class="rd-navbar-right-buttons group d-inline-block"><a class="btn btn-primary" href="register-login.html#undefined1" style="max-height: 40px; line-height: 22px;" target="_blank"><span class="big">Login</span></a>
                  <div class="text-middle d-xl-inline-block">
                    <p class="big text-muted font-weight-bold">or</p>
              ...
              <div class="parallax-content">
                <div class="bg-overlay-gray-darkest">
                  <div class="container section-top-98 section-bottom-34 section-lg-bottom-66 section-lg-98 section-xl-top-155 section-xl-bottom-66">
                    <div class="text-extra-big font-weight-bold d-none d-lg-block">Blog</div>
      ...
      <section class="section-98 section-md-124 novi-background" data-preset='{"title":"Blog 2","category":"content, blog","reload":true,"id":"blog-2"}'>
          ...
          <div class="row justify-content-sm-center">
            <div class="col-xl-8">
              <div class="row justify-content-sm-center">
                ...
                <div class="col-12 offset-top-66"><a class="btn btn-primary" href="#">view all blog posts</a></div>
              </div>
            </div>
            <div class="col-md-9 col-xl-3 offset-top-66 offset-xl-top-0">
              <div class="inset-xxl-left-100">
                <!-- Sidebar-->
                <aside class="text-left">
                  <div class="row">
                    ...
                    <div class="col-sm-12 offset-top-41">
                      <!-- Twitter Feed-->
                    ...
                    <div class="col-sm-6 col-lg-12 offset-top-41">
                      <!-- Category-->
                    ...
                    <div class="col-sm-6 col-lg-12 offset-top-41 offset-sm-top-0 offset-lg-top-41">
                      <!-- Archive-->
                      <h6 class="text-uppercase text-spacing-60">Archive</h6>
                      <div class="text-subline"></div>
                      <ul class="list list-marked offset-top-30">
                        <li><a href="#">January 2018 <span class="text-dark">(17)</span></a></li>
                        <li><a href="#">December 2017 <span class="text-dark">(121)</span></a></li>
                        <li><a href="#">November 2017 <span class="text-dark">(19)</span></a></li>
                        <li><a href="#">October 2017 <span class="text-dark">(9)</span></a></li>
                        <li><a href="#">September 2017 <span class="text-dark">(25)</span></a></li>
                      </ul>
                    </div>
                    <div class="col-sm-12 offset-top-41">
                      <!-- Tags-->
                      ...
                      <div class="text-subline"></div>
                      <div class="offset-top-34">
                        <div class="group-xs tag-list"><a class="btn btn-xs btn-default" href="#">resume</a><a class="btn btn-xs btn-default" href="#">employers</a><a class="btn btn-xs btn-default" href="#">Job</a><a class="btn btn-xs btn-default" href="#">Vacancy</a><a class="btn btn-xs btn-default" href="#">Finance</a>
                        </div>
                      </div>
                    </div>
                  </div>
