...
<div class="page text-center">
    ...
    <section class="img-responsive" style="background: #ecf1f8 url('{{ asset("images/sectionGrid.png") }}') ;background-repeat: no-repeat;background-size: 100% 100%;height: 1000px;">
        <div class="container">
            ...
            <div class="owl-carousel owl-carousel-classic owl-carousel-class-light veil-owl-nav owl-carousel-testimonials-3 slide" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="3" data-nav="false" data-dots="true" data-margin="50px" data-autoplay="true" data-autoloop="true">
