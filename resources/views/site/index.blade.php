...
<div class="page text-center">
    ...
    <section  class="section-41  novi-background" >
        ...
        <div class="container">
            <div class="owl-carousel owl-carousel-classic owl-carousel-class-light veil-owl-nav owl-carousel-testimonials-3 slide mt-5" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="3" data-nav="false" data-dots="false" data-margin="50px" data-autoplay="true" data-loop="true">
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    <div class="unit-left"></div>
