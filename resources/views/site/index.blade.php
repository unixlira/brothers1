...
<div class="page text-center">
    ...
    <section class="section-98 section-md-110  novi-background" data-preset='{"title":"Blog 1","category":"content, blog","reload":true,"id":"blog-1"}' >
        ...
        <div class="container">
            <div class="owl-carousel owl-carousel-classic owl-carousel-class-light veil-owl-nav owl-carousel-testimonials-3 slide mt-5" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="3" data-nav="false" data-dots="false" data-margin="50px" data-autoplay="true">
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    <div class="unit-left"></div>
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/citroen-c3.jpg") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/duster.jpg") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/ford-ecosport.png") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/hb20.jpg") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/march.jpg") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/argo.png") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/onix.jpg") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/polo.png") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/toyota-corolla.jpg") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
                <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                    ...
                    <div class="unit-body text-left">
                        <div>
                            <p>
                                <q><img class="card-img-top" src="{{ asset("images/honda.png") }}" alt="" width="210" height="300"></q>
                            </p>
                        </div>
                    </div>
                </blockquote>
        ...
        <div class="col-12 offset-top-66"><a class="btn btn-danger" href="/estoque">Ver todas marcas</a></div>
    </section>
                        ...
                        <blockquote class="quote quote-slider-4 unit uni-spacing-sm flex-md-row">
                            ...
                            <div class="unit-body text-left" style="background-color: white;padding: 25px;border-radius: 10px;">
                                <div>
                                    ...
                                    <hr style="border: 1px solid black" />
                                    <p class="container font-weight-bold" >
                                        <cite class="text-center row offset-1">
                                            <i class="novi-icon fa fa-road mr-3"> {{$node['quilometragem']}}&nbsp; </i>
                                            <i class="novi-icon fa fa-cog mr-3"> {{$node['cambio']}}&nbsp; </i>
                                            <i class="novi-icon fa fa-adjust mr-3"> {{$node['cor']}}&nbsp; </i>
                                        </cite>
