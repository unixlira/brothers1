    ...
    <body>
        ...
        <!-- <div class="page-loader page-loader-variant-1">
            ...
            <header class="page-head slider-menu-position" data-preset='{"title":"Header 1","category":"header, parallax","reload":true,"id":"header-1"}'>
                ...
                <div class="section-98 parallax-container " style="background-position: center !important;" data-parallax-img="{{ asset('images/banner-analise.png') }}"></div>
            </header>
            <!-- Contact Us-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-7">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap nome"><input type="text" name="nome" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Digite seu nome" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap data-nasc"><input type="text" name="nascimento" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Data de Nascimento" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap rg"><input type="text" name="rg" value="" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="RG" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap cpf"><input type="text" name="cpf" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="CPF" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap nome-mae"><input type="text" name="mae" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Nome da Mãe" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap endereco"><input type="text" name="endereco" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Endereço" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="contact-us-label">Estado</div>
                                                        <p><span class="wpcf7-form-control-wrap estado"><input type="text" name="estado" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Estado" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap cidade"><input type="text" name="cidade" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Cidade" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap telefone"><input type="text" name="telefone" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Telefone" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p><span class="wpcf7-form-control-wrap celular"><input type="text" name="celular" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Celular" /></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <p><span class="wpcf7-form-control-wrap nome-empresa"><input type="text" name="empresa" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Nome da empresa" /></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <p><span class="wpcf7-form-control-wrap cargo"><input type="text" name="cargo" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Cargo" /></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <p><span class="wpcf7-form-control-wrap renda"><input type="text" name="renda" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Renda" /></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <p><span class="wpcf7-form-control-wrap tempo-empresa"><input type="text" name="tempoempresa" value="" size="40" class="form-control" id="contact-us-message" style="background:#ecf1f8" placeholder="Tempo de Empresa" /></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
