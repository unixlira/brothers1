<DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
              href="//fonts.googleapis.com/css?family=Open+Sans:400,400italic,600,700,700italic">
    ...
    <div><img class='img-responsive' style='margin-top: -20px;margin-left: -5px;' width='135' height='55' src='images/logo_big.png' alt=''/>
                ...
                <nav class="rd-navbar container rd-navbar-floated rd-navbar-dark rd-navbar-dark-transparent"
                    ...
                    <div class="rd-navbar-inner">
                        ...
                        <div class="rd-navbar-panel">
                            ...
                            <button class="rd-navbar-right-buttons-toggle"
                                    data-rd-navbar-toggle=".rd-navbar, .rd-navbar-right-buttons"><span></span></button>
                            <!--Navbar Brand-->
                            <div class="rd-navbar-brand"><a href="/"><img width='135' height='55'
                                                                          src='{{ asset('images/logo_big.png') }}'
                                                                          alt='Smart Veículos'/></a></div>
                        </div>
                        <div class="rd-navbar-menu-wrap">
                            <div class="rd-navbar-nav-wrap">
                                <div class="rd-navbar-mobile-scroll">
                                    <!--Navbar Brand Mobile-->
                                    <div class="rd-navbar-mobile-brand"><a href="/"><img width='218' height='35'
                                                                                         src='{{ asset('images/logo_big.png') }}'
                                                                                         alt=''/></a></div>
                                    <!-- RD Navbar Nav-->
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li><a href="{{url('compras')}}"
                                               style="border: 2px solid #eb232c;border-radius: 25px;padding: 10px;top: -10px;"><span>Venda seu Carro</span></a>
                                        </li>
                                        <li><a href="{{url('veiculos')}}"
                                               style="border-radius: 55px;background-color: #eb232c;padding: 12px;top: -10px;"><span>Nossos Veículos</span></a>
                                        </li>
                                        <li><a href="{{url('https://api.whatsapp.com/send?phone=11990253050')}}"
                                               style="top:-10px;margin-right: -2px" target="_blank">
                                                <span><img src="{{ asset('images/whatsapp3-36x36.png') }}"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <p href="" style="margin-top: -15px;margin-left: -50px !important;">
                                                <span class="rd-navbar-nav"
                                                      style="color: #0EFFC0;">Consultor OnLine</span>
                                            <h5 class="text-white" style="margin-top: -20px;margin-left: -50px;"><b>15 99712-1257mensagem</b></h5>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
        ...
        <section class="section-34" style="background-color:#ecf1f8">
            <div class="text-center">
                <h2 class="text font-weight-bold" style="color: #191919 !important">Financie On-line com as
                    melhores taxas</h2>
            </div>
            <div class="container bg-white text-left mt-5" style="padding:35px;
  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin-top: 10px;">
                <form action="{{route('contatoAnalise')}}" method="POST">
                    @csrf
                    <input type="hidden" name="tipo" value="analise">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap nome"><input type="text"
                                                                                                         name="nome"
                                                                                                         value=""
                                                                                                         size="40"
                                                                                                         class="form-control"
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap data-nasc"><input
                                                                type="text" name="nascimento" value="" size="40"
                                                                class="form-control" id="contact-us-message"
                                                                 style="background:#ecf1f8"
                                                                placeholder="Data de Nascimento"/></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap rg"><input type="text"
                                                                                                       name="rg"
                                                                                                       value=""
                                                                                                       class="form-control"
                                                                                                       id="contact-us-message"
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap cpf"><input type="text"
                                                                                                        name="cpf"
                                                                                                        value=""
                                                                                                        size="40"
                                                                                                        class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap nome-mae"><input type="text"
                                                                                                             name="mae"
                                                                                                             value=""
                                                                                                             size="40"
                                                                                                             class="form-control"
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap endereco"><input type="text"
                                                                                                             name="endereco"
                                                                                                             value=""
                                                                                                             size="40"
                                                                                                             class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap cidade"><input type="text"
                                                                                                           name="cidade"
                                                                                                           value=""
                                                                                                           size="40"
                                                                                                           class="form-control"
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap telefone"><input type="text"
                                                                                                             name="telefone"
                                                                                                             value=""
                                                                                                             size="40"
                                                                                                             class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap celular"><input type="text"
                                                                                                            name="celular1"
                                                                                                            value=""
                                                                                                            size="40"
                                                                                                            class="form-control"
                                    ...
                                    <div class="container mt-5">
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><span class="wpcf7-form-control-wrap nome-empresa"><input
                                                                        type="text" name="empresa" value="" size="40"
                                                                        class="form-control" id="contact-us-message"
                                                                        style="background:#ecf1f8"
                                                                        placeholder="Nome da empresa"/></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><span class="wpcf7-form-control-wrap cargo"><input
                                                                        type="text" name="cargo" value="" size="40"
                                                                        class="form-control" id="contact-us-message"
                                                                        style="background:#ecf1f8"
                                                                        placeholder="Cargo"/></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><span class="wpcf7-form-control-wrap renda"><input
                                                                        type="text" name="renda" value="" size="40"
                                                                        class="form-control" id="contact-us-message"
                                                                        style="background:#ecf1f8"
                                                                        placeholder="Renda"/></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><span class="wpcf7-form-control-wrap tempo-empresa"><input
                                                                        type="text" name="tempoempresa" value="" size="40"
                                                                        class="form-control" id="contact-us-message"
                                                                        style="background:#ecf1f8"
                                                                        placeholder="Tempo de Empresa"/></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-12 offset-top-20">
                                                <div class="form-group">
                                                <textarea class="form-control" id="contact-us-message" name="mensagem"
                                                          style="background:#ecf1f8"
                                                          placeholder="Deixe sua mensagem e retornaremos..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                     ...
                     <!-- Icon Box Type 2-->
                        <div class="unit unit-sm flex-md-row text-md-left ">
                            <div class="unit-body row text-center text-justify offset-md-top-10 text-white">
                                ...
                                <br>
                                <div class="redes">
                                    <a href="vendas.websmartveiculos@gmail.com" class="email" target="_blank"> <svg id="mail" xmlns="http://www.w3.org/2000/svg" width="40.882" height="31.141" viewBox="0 0 40.882 31.141">
                                    ...
                                    <a href="https://api.whatsapp.com/send?phone=5515997121257&text=Ol%C3%A1%2C%20estou%20no%20site%20da%20Smart%20Ve%C3%ADculos%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es." class="whatsapp" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" width="30.423" height="30.57" viewBox="0 0 30.423 30.57">
                                    ...
                                    <a href="https://www.facebook.com/SmartVeiculosSorocaba" class="facebook" target="_blank"> <svg id="facebook" xmlns="http://www.w3.org/2000/svg" width="30.63" height="30.63" viewBox="0 0 30.63 30.63">
                                    ...
                                    <a href=" https://www.instagram.com/smartveiculos/?hl=pt-br" class="instagram" target="_blank"> <svg id="instagram-sketched" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30.57" height="30.569" viewBox="0 0 30.57 30.569">
                                            <defs>
