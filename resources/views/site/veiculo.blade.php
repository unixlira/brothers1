            ...
            <div class="row">
                <div class="col-sm-8">
                    <section class="container mb-5">
                        <div>
                            <div class="mt-5 mb-5">
                                <h4 class="text-left">{{ $busca[0]['marca'] .' '. $busca[0]['modelo']}}<br> {{$busca[0]['versao']}}</h4>
                                <div class="text-bold text-right" style="margin-top: -76px;">
                                    <span style="background-color: #eb232c;color: white;padding: 10px;font-size: 25px">{{$busca[0]['preco']}}</span>
                                </div>
                            </div>
                ...
                <div class="col-sm-3">
                    <div>
                        <img width="230" style="margin-top: 45px;margin-bottom: 30px;" src="{{asset('images/logo-whatsapp.png')}}" />
                    </div>
