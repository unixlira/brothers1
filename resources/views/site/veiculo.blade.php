...
<body>
    ...
    <div class="page text-center">
        ...
        <header class="page-head slider-menu-position" data-preset='{"title":"Header 1","category":"header, parallax","reload":true,"id":"header-1"}'>
            ...
            <div class="section-66 parallax-container bg-dark"></div>
        </header>
        <div class="container offfset">
            <div class="row">
                <div class="col-sm-8">
                    <section class="container mb-5">
                        <div>
                            <div class="mt-5 mb-5">
                                <h4 class="text-left">{{ $busca[0]['marca'] .' '. $busca[0]['modelo'] .' '. $busca[0]['versao']}}</h4>
                        ...
                        <div class=" mt-2">
                            <div class="owl-carousel owl-carousel-default owl-carousel-class-light" data-loop="true" data-items="1" data-md-items="2" data-dots="true" data-mouse-drag="false" data-lg-items="5" data-nav="false" data-xs-margin="30px" data-autoplay="true">
                                ...
                                @foreach($node['fotos']['foto'] as $foto)
                                <div class="mr-5">
                                    <figure><img width="147" height="110" src="{{$foto['url']}}" alt="{{$node['modelo']}}" onclick="currentSlide({{$foto['ordem']}})" />
                                    </figure>
                                </div>
                                @endforeach
                                @endforeach
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12 text-left">
                                        <i class="novi-icon fa fa-check-circle mr-3 text-red"></i>
                                        <span>SMART VEÍCULOS MULTIMARCAS, Veículos com qualidade, preço justo e procedência 3 lojas em Sorocaba para melhor servir. 
                                        A melhor Avaliação no seu usado. Veículos com laudo cautelar completo, revisados e documentação ok. 
                                        Trabalhamos com todas financeiras SEJA INTELIGENTE SEJA SMART, AQUI É FÁCIL COMPRAR Os valores anunciados são para pagamento a vista, para financiamento e troca, fale com nossos consultores. 
                                        RESERVAMOS O DIREITO DE EVENTUAIS ERROS DE DIGITAÇÃO NA DESCRIÇÃO, VALORES OU FOTOS. </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-3">
                        ...
                        <div class="text-bold text-center" style="margin-top: 46px;">
                            <span style="background-color: #eb232c;color: white;padding: 26px;font-size: 35px">{{$busca[0]['preco']}}</span>
                        </div>
                    <br>
                    <br>
                    <div>
                        <h5 class="text-black text-left">Entre em contato </h5>
                        <form method="POST" action="{{route('contatoVeiculo')}}">
                            ...
                            @endif
                            @if($status=='enviada')
                                <button class="text-white text-bold btn btn-success btn-block" disabled>{{$mensagem}}</button>
                            @endif
                        </form>
                    </div>
                    <div class="container text-white bg-dark col-12 mt-4" >
                        <div class="text-center m-auto" ><br> 
                            <span class="text-bold pt-4">Ligue ou fale pelo WhatsApp</span>
                    ...
                    <div class="mt-5">
                        <h5>Veja Também</h5>
                        <hr style="border: 2px #153e4d solid">
                        <br>
                    </div>
                    <div class="container mt-2">
                        ...
                        <div class="row" style="margin-top: -10px;">
                            <div class="col-lg-6 col-md-5 col-sm-4 mt-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25.85" height="18" viewBox="0 0 25.85 22.403"> 
                                    <path id="Caminho_868" data-name="Caminho 868" d="M26.557,12.462H25.7a.431.431,0,0,0-.431.431v3.877H24.4V12.462a1.3,1.3,0,0,0-1.292-1.292H20.526V9.447h4.308a.431.431,0,0,0,.431-.431V8.154A2.154,2.154,0,0,0,23.111,6H14.494A2.154,2.154,0,0,0,12.34,8.154v.862a.431.431,0,0,0,.431.431h4.308V11.17h-3.4a.407.407,0,0,0-.246.078L9.191,14.186H6.739a1.3,1.3,0,0,0-1.292,1.292v5.6H4.585V17.2a.431.431,0,0,0-.431-.431H3.292A1.3,1.3,0,0,0,2,18.063V26.68a1.3,1.3,0,0,0,1.292,1.292h.862a.431.431,0,0,0,.431-.431V23.664h.862v3.447A1.3,1.3,0,0,0,6.739,28.4H18.673a1.3,1.3,0,0,0,1.18-.767l1.383-3.111h2.736a.431.431,0,0,0,.431-.431V19.356h.862v3.877a.431.431,0,0,0,.431.431h.862a1.3,1.3,0,0,0,1.292-1.292V13.755a1.3,1.3,0,0,0-1.292-1.292ZM3.723,27.111H3.292a.431.431,0,0,1-.431-.431V18.063a.431.431,0,0,1,.431-.431h.431ZM5.447,22.8H4.585v-.862h.862ZM13.2,8.585V8.154a1.3,1.3,0,0,1,1.292-1.292h8.617A1.3,1.3,0,0,1,24.4,8.154v.431Zm6.462.862V11.17H17.941V9.447Zm3.877,14.217H20.956a.425.425,0,0,0-.392.254l-1.5,3.369a.431.431,0,0,1-.392.254H6.739a.431.431,0,0,1-.431-.431V15.478a.431.431,0,0,1,.431-.431H9.324a.426.426,0,0,0,.246-.078l4.239-2.938h9.3a.431.431,0,0,1,.431.431Zm1.723-5.17H24.4v-.862h.862Zm1.723,3.877a.431.431,0,0,1-.431.431h-.431V13.324h.431a.431.431,0,0,1,.431.431Z" transform="translate(-2 -6)" fill="#eb232c"/> <path id="Caminho_871" data-name="Caminho 871" d="M48,22h.862v.862H48Z" transform="translate(-28.182 -15.107)" fill="#eb232c"/> <path id="Caminho_872" data-name="Caminho 872" d="M44,22h.862v.862H44Z" transform="translate(-25.905 -15.107)" fill="#eb232c"/> <path id="Caminho_873" data-name="Caminho 873" d="M14,52h.862v.862H14Z" transform="translate(-8.83 -32.182)" fill="#eb232c"/> <path id="Caminho_874" data-name="Caminho 874" d="M18,52h.862v.862H18Z" transform="translate(-11.107 -32.182)" fill="#eb232c"/> 
                                </svg>

                                <span style="font-size: 13px;font-weight: bold">{{$newXml[1]['quilometragem']}} KM</span>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row" style="margin-top: -10px;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="25.85" height="18" viewBox="0 0 25.85 22.403"> 
                                ...
                                <span style="font-size: 13px;font-weight: bold">{{$newXml[5]['quilometragem']}} KM</span>
                            </div>
                            <div class="col-lg-6 col-md-5 col-sm-4 text-bold mt-3">
                    ...
                    <div class="container">
                        ...
                        <div class="row" style="margin-top: -10px;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="25.85" height="18" viewBox="0 0 25.85 22.403"> 
                                ...
                                <span style="font-size: 13px;font-weight: bold">{{$newXml[7]['quilometragem']}} KM</span>
                            </div>
                            <div class="col-lg-6 col-md-5 col-sm-4  text-bold mt-3">
                    ...
                    @if(!empty($busca[0]['observacoes']))
                        <div class="container">
                            ...
                            <div class="row" style="margin-top: -10px;">
                                ...
                                <span style="font-size: 13px;font-weight: bold">{{$newXml[11]['quilometragem']}} KM</span>
                                </div>
                                <div class="col-lg-6 col-md-5 col-sm-4 text-bold mt-3">
