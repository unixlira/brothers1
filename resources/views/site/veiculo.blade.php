                    ...
                    <section class="container mb-5">
                        ...
                        <div class="" style="margin-top: -30px;">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm">
                                        <i class="novi-icon fa fa-road mr-3" style="color: #888888"> Kilometragem</i><br>
                                        {{$busca[0]['quilometragem']}}
                                    </div>
                                    <div class="col-sm">
                                        <i class="novi-icon mdi mdi-gas-station mr-3" style="color: #888888"> Combustível</i><br>
                                        {{$busca[0]['combustivel']}}
                                    </div>
                                    <div class="col-sm">
                                        <i class="novi-icon fa fa-cog mr-3" style="color: #888888"> Transmissão</i><br>
                                        {{$busca[0]['cambio']}}
                                    </div>
                                    <div class="col-sm">
                                        <i class="novi-icon fa fa-adjust mr-3" style="color: #888888"> Cor Exterior</i><br>
                                        {{$busca[0]['cor']}}
                                    </div>
                                </div>
                            </div>
