...
<div class="page text-center">
    ...
    <header class="page-head slider-menu-position" data-preset='{"title":"Header 1","category":"header, parallax","reload":true,"id":"header-1"}'>
        ...
        <div class="section-155 parallax-container" class="img-fluid" style="background-position: center !important;" data-parallax-img="{{ asset('images/banner-veiculos.jpg') }}"></div>
    </header>
    <section>
        <div class="mt-5 mb-5">
            ...
            <form action="{{ route('buscar') }}" method="GET">
                    <div class="tab-pane active" id="1b">
                        <div class="row">
                            ...
                            <div class="col-sm-5 mb-2" id="modelo">
                            ...
                            <div class="col-sm-5 mb-2" id="select2" style="display: none;">
                                <select name ="modelo" id="showModelo">
                                    <option value="false">Modelo</option>
                                </select>
                            </div>
                            <div class="col-sm">
                                <button type="submit" class="btn btn-danger  btn-block mb-2"><i class="novi-icon fa fa-search"></i> Buscar</button>
                                <!-- <a href="{{ route('veiculos')}}"  class="btn btn-dark btn-block"><i class="novi-icon fa fa-search"></i> Todos Veículos</a> -->
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <div class="">
                                        ...
                                        <div class="row justify-content-center grid-group-md text-xl-left">
                                            <div class="mr-4 ">
                                                <div class="">
                                                    <div class="">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="29.416" height="15.56" viewBox="0 0 29.416 15.56"> 
                                                    ...
                                                    <div class="dado cor">
                                                        <svg id="art" xmlns="http://www.w3.org/2000/svg" width="21.931" height="20.853" viewBox="0 0 21.931 20.853"> 
                                                ...
                                                <div>
                                                    <div class="">
                                                        <div class="dado quilometragem">
                                                            <svg id="engine_power" data-name="engine power" xmlns="http://www.w3.org/2000/svg" width="25.85" height="22.403" viewBox="0 0 25.85 22.403"> 
                                                        ...
                                                        <div class="dado cambio">
                                                            <svg id="car" xmlns="http://www.w3.org/2000/svg" width="22.587" height="22.587" viewBox="0 0 22.587 22.587"> 
