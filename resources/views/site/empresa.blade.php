            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 m-auto">
                        ...
                        <p><small>Desde 2014, a loja Smart Veículos, fundada pelos empreendedores Robson Camacho e Nilton Spuzzillo Júnior - ambos com ampla vivência no mercado de veículos seminovos, vem trazendo qualidade e excelência em seus produtos, comprovados ao longo do tempo pela sua estrutura consolidada (Hoje com 3 lojas em Sorocaba/SP), conhecidos por serem uma das únicas lojas a oferecer 6 meses de garantia a todos os clientes em seus produtos, provando assim realmente fazer manutenções prévias de qualidade, garantindo todos os serviços efetuados, além de obter um estoque de real procedência com veículos periciados e laudos aprovados.
 <br><br>São mais de 100 veículos com preços competitivos, taxas de negociação, avaliação justa dos veículos que entram em negociações de troca e atendimento prioritário ao nosso cliente, trazendo assim nosso objetivo de entregar a completa satisfação de nossos clientes, estando ao seu lado em todas etapas da realização em direção à realização de seu sonho!
                                <br><br>Vem pra Smart Veículos! Fale com a gente e confira!</small></p>
                        </p>
        ...
        <section class="section novi-background section-66" style="overflow: hidden; background-color:#191919">
            <h1 class="font-weight-bold text-white text-md-center">Conheça nossas lojas</h1>
            <div class="container">
              
                    <div class="rd-navbar-mobile-brand"><a href="/"><img width="570" height="380" src='{{ asset('images/loja1.jpeg') }}' alt='' /></a></div>
                <br>
                    <div class="rd-navbar-mobile-brand"><a href="/"><img width="570" height="380" src='{{ asset('images/loja2.jpeg') }}' alt='' /></a></div>
              <br>
                    <div class="rd-navbar-mobile-brand"><a href="/"><img width="570" height="380" src='{{ asset('images/loja3.jpeg') }}' alt='' /></a></div>
        ...
        <section class="newsletter" style="background-image: url(website/img/temporario/footer/newsletter_br[1920x295].png);">
            <div class="content">
                ...
                <div class="form_content">
                    ...
                    <p>Receba todas nossas novidades e ofertas em primeira mão</p>
                    <form id="newsletters" action="javascript:;" method="post">
                        <input name="id_pagina" type="hidden" value="2">
                        <input name="nome" placeholder="Seu nome">
                        <input name="email" placeholder="Seu e-mail">
                        <input name="telefone" placeholder="Seu celular" mask="telefone">
                        <button class="clickformsubmit">Enviar</button>
                    </form>
                </div>
            </div>
        </section>
