        ...
        <section class="bg-white section-top-66 section-bottom-34">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p><small>Desde 2014, a loja Smart Veículos, fundada pelos empreendedores Robson Camacho e Nilton Spuzzillo Júnior - ambos com ampla vivência no mercado de veículos seminovos,
                                vem trazendo qualidade e excelência em seus produtos, comprovados ao longo do tempo pela sua estrutura consolidada (Hoje com 3 lojas em Sorocaba/SP), conhecidos por serem uma
                                das únicas lojas a oferecer 6 meses de garantia a todos os clientes em seus produtos, provando assim realmente fazer manutenções prévias de qualidade, garantindo todos os serviços efetuados,
                                além de obter um estoque de real procedência com veículos periciados e laudos aprovados.
                                São mais de 100 veículos com preços competitivos, taxas de negociação, avaliação justa dos veículos que entram em negociações de troca e atendimento prioritário ao nosso cliente,
                                trazendo assim nosso objetivo de entregar a completa satisfação de nossos clientes, estando ao seu lado em todas etapas da realização em direção à realização de seu sonho!
                                Vem pra Smart Veículos! Fale com a gente e confira!</small></p>
                        </p>
                                ...
                                <div class="row">
                                    <div class="col-md-9 mb-2">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" style="background:#ecf1f8" placeholder="Seu email">
